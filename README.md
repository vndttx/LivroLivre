...
ℹ**Acesse a aplicação online e saiba mais através da nossa página oficial:** [https://vndttx.github.io/livrolivre/](https://vndttx.github.io/livrolivre/)
...
* **Google Cloud Firestore** / **MySQL** para ambiente de produção
...
* **Integridade Referencial e Controle de Estoque:** Dedução automática e estrita de quantidades de livros disponíveis imediatamente após o aceite de transações diretamente no banco de dados.
* **Proteção de Dados:** Mascaramento estrito de informações sensíveis do usuário, exibindo apenas identificadores de usabilidade pública (como nome do proprietário) para preservar a privacidade e a segurança no catálogo e carrinho.
...
* Conta ou emulador do Google Cloud Firestore / Servidor MySQL ativo
